[shader-library](../README.md) › [Globals](../globals.md) › ["src/js/GPX/Commands/shader"](../modules/_src_js_gpx_commands_shader_.md) › [ShaderSources](_src_js_gpx_commands_shader_.shadersources.md)
